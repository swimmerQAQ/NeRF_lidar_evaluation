...
class SemanticKitti(Dataset):
  ...
  def __getitem__(self, index):
    ...
    # print(scan_file , self.learning_map)
    ...
    if self.gt:
      ...
      # print("before",np.unique(scan.sem_label),label_file)
      # print("rule:" , self.learning_map)
  ...
  @staticmethod
  def map(label, mapdict , path=None , ):
...
class Parser():
  ...
  def __init__(self,
    ...
    if 'semantickitti_nerf_city' not in self.valroot :
      self.val_lm = self.datacfg['nerf_use_mapping_real']
    self.learning_map_inv = learning_map_inv
    self.sensor = sensor
    self.max_points = max_points
