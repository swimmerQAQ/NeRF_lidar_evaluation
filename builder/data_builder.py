...
def build(dataset_config,
    ...
    label_mapping_val = dataset_config["label_mapping_val"]
    SemKITTI = get_pc_model_class(dataset_config['pc_dataset_type'])
    SemKITTI_val = get_pc_model_class(dataset_config['pc_dataset_type_val'])
    ...
    val_pt_dataset = SemKITTI_val(val_dataloader_config['data_path'], imageset=val_imageset,
                              return_ref=val_ref, label_mapping=label_mapping_val, nusc=nusc)
