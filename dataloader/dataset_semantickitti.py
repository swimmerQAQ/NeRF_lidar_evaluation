...
class cylinder_dataset(data.Dataset):
    def __init__(self, in_dataset, grid_size, rotate_aug=False, flip_aug=False, ignore_label=255, return_test=False,
        ...
        ###################visiualize
        import time
        # self.file_write = open('/SSD_DISK/users/kuangshaochen/Cylinder3D/visiualize_real/'+ str(time.time()) + 'vfine.txt','w')
        print("\ninit file\n")
    ...
    def __getitem__(self, index):
        ...
        data_tuple = (voxel_position, processed_label)
        #############################################################
        # np.save('/SSD_DISK/users/kuangshaochen/Cylinder3D/visiual_real/gts/{:04d}.npy'.format(index),processed_label)
        # np.save('/SSD_DISK/users/kuangshaochen/Cylinder3D/visiualize_real/voxel/{:05d}.npy'.format(index),label_voxel_pair)
        # (480, 360, 32) (34656, 4) (34656, 3) (34656, 1) (34656, 3)
        # print(processed_label.shape , label_voxel_pair.shape , xyz_pol.shape , labels.shape , xyz.shape)
        # for i in range(labels.shape[0]) :
        #     test_coor = label_voxel_pair[0]
        #     test_lab = processed_label[test_coor[0],test_coor[1],test_coor[2]]
        #     if test_lab != test_coor[3] :
        #         print(test_lab , test_coor[3])
